        ...
        <div className="w-full max-w-sm bg-white rounded-lg shadow-md hover:shadow-lg border-gray-700 m-auto basis-1/3 my-3">
            ...
            <div className="px-5 pb-5">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center cursor-pointer" onClick={() => {
                        setItem({ name: slug, id })
